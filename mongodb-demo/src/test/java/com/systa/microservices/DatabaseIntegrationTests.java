...
public class DatabaseIntegrationTests {
    ...
    @Autowired
    FlightInformationV2Repository flightInformationRepository;
    ...
    public void afterEach() {
        ...
        this.mongoTemplate.dropCollection(FlightInformationV2.class);
    }
    ...
    public void findByMinAircraftNbSeatsShouldWork() {
        ...
        // act
        List<FlightInformationV2> flights = this.flightInformationRepository
    ...
    public void theCascadeOnSaveShouldWork() {
        ...
        FlightInformationV2 flight = new FlightInformationV2();
        ...
        // assert
        FlightInformationV2 dbFlight = this.flightInformationRepository
